...
📄 **[migrations/migration-central-database.sql](migrations/migration-central-database.sql)**
...
📄 **[migrations/migration-tenant-database.sql](migrations/migration-tenant-database.sql)**
...
### Banco de Dados
- **Schema Central**: [migrations/migration-central-database.sql](migrations/migration-central-database.sql)
- **Schema Tenant**: [migrations/migration-tenant-database.sql](migrations/migration-tenant-database.sql)
